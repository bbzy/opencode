...
export const CycleReflectDescription =
  "Canonical reflection guidance for a stalled opencode /cycle automation. The Cycle scheduler injects this content directly after its tool-free threshold, so do not load it with the skill tool during Cycle rounds. Do not use it at Cycle startup, during ordinary active rounds, for /loop, or for ordinary tasks."

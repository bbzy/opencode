...
Default local scope belongs only to this session. Global edits require an explicit user request and must be durable across sessions; qualify project-specific lessons by project. Entries in the other scope are read-only context.

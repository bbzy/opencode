...
- Unattended cycle runs receive a soft checkpoint instruction at `loopConfig.maxRoundProviderTurns`: finish the current atomic operation, reconcile todos, report evidence, and yield to the next round without interrupting in-flight tools.
